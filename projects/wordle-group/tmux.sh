#!/bin/bash
# Tmux session for wordle-group (laravel)
...
tmux send-keys -t $SESSION:$TABNO "docker exec -it wordle-group-php php artisan tinker" C-m
TABNO=$((TABNO+1))
